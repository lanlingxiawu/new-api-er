...
const (
	...
	MsgUserGroupRatioCleanupInProgress = "user.group_ratio_cleanup_in_progress"
	...
	MsgUserRegisterTooFrequent         = "user.register_too_frequent"
...
const (
	...
	MsgChannelDailyLimitInvalidAmount         = "channel.daily_limit.invalid_amount"
	MsgChannelDailyLimitInvalidRecoverMinutes = "channel.daily_limit.invalid_recover_minutes"
)
...
const (
	...
	MsgGroupDeleteHasEnabledChannels  = "group.delete_has_enabled_channels"
	MsgGroupDeleteChannelCheckFailed  = "group.delete_channel_check_failed"
	MsgGroupRatioMasterRequired       = "group.ratio_master_required"
	MsgGroupRecreateCleanupInProgress = "group.recreate_cleanup_in_progress"
)
...
const (
	...
	MsgPricingConfigChanged        = "price_monitor.pricing_config_changed"
	MsgPriceMonitorSnapshotStale   = "price_monitor.snapshot_stale"
	MsgPriceMonitorExprNotEditable = "price_monitor.expr_not_editable"
	MsgPriceMonitorTooManyModels   = "price_monitor.too_many_models"
