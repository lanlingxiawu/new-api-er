...
const getGroupDefaults = (settings: BillingSettings) => ({
  ...
  UserExclusiveGroupRatioEnabled: settings.UserExclusiveGroupRatioEnabled,
  UserExclusiveGroupRatioCacheMax: settings.UserExclusiveGroupRatioCacheMax,
    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          StripeUseRealtimeRate: settings.StripeUseRealtimeRate,
        ...
        wechatDefaultValues={{
          ...
          WechatMchPrivateKey: settings.WechatMchPrivateKey ?? '',
          WechatMchCertSerialNo: settings.WechatMchCertSerialNo ?? '',
