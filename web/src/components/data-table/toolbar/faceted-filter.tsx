...
type DataTableFacetedFilterProps<TData, TValue> = {
  ...
  /**
   * Current filter value of the column. Passed explicitly so this memoized
   * chip re-renders when the value changes: the column instance is stable and
   * callers may memoize `options`, so without it React.memo would skip the
   * update and the selected-value badge would never appear.
   */
  filterValue?: unknown
}
...
function DataTableFacetedFilterInner<TData, TValue>({
  ...
  const filterValue = (filterValueProp ?? column?.getFilterValue()) as
    | string[]
    | undefined
