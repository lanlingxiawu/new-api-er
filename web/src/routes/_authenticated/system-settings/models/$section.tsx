...
import { MODELS_SECTION_IDS } from '@/features/system-settings/models/section-registry.tsx'
...
export const Route = createFileRoute(
  ...
  beforeLoad: ({ params }) => {
    requireSystemSettingsSection('models', params.section, MODELS_SECTION_IDS)
  },
