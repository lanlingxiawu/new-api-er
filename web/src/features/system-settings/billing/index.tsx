...
const defaultBillingSettings: BillingSettings = {
  ...
  'price_monitor_setting.enabled': false,
  'price_monitor_setting.interval_minutes': 360,
  'price_monitor_setting.timeout_seconds': 10,
  'price_monitor_setting.include_official': true,
  'price_monitor_setting.include_models_dev': false,
  'price_monitor_setting.model_whitelist': '',
  TopupGroupRatio: '',
  GroupRatio: '',
  UserUsableGroups: '',
  GroupGroupRatio: '',
