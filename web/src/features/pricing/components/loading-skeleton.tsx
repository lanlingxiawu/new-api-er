...
// Stable keys for the static placeholder repeats below.
const CARD_SKELETON_IDS = Array.from({ length: 9 }, (_, i) => `card-${i}`)
const TABLE_ROW_SKELETON_IDS = Array.from({ length: 10 }, (_, i) => `row-${i}`)
const PAGINATION_SKELETON_IDS = Array.from({ length: 4 }, (_, i) => `page-${i}`)
