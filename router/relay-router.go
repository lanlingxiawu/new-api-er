...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.RequestResponseLogger())
	playgroundRouter.Use(middleware.SystemPerformanceCheck())
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute())
	playgroundRouter.Use(middleware.RelayRequestTimeout())
	{
	...
	relayV1Router.Use(middleware.RelayRequestTimeout())
	{
	...
	relayMjRouter.Use(middleware.RequestResponseLogger())
	relayMjRouter.Use(middleware.SystemPerformanceCheck())
	registerMjRouterGroup(relayMjRouter)

	relayMjModeRouter := router.Group("/:mode/mj")
	relayMjModeRouter.Use(middleware.RouteTag("relay"))
	relayMjModeRouter.Use(middleware.RequestResponseLogger())
	...
	relaySunoRouter.Use(middleware.RequestResponseLogger())
	relaySunoRouter.Use(middleware.SystemPerformanceCheck())
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.Distribute())
	relaySunoRouter.Use(middleware.RelayRequestTimeout())
	{
	...
	relayGeminiRouter.Use(middleware.RelayRequestTimeout())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.RelayRequestTimeout())
	{
