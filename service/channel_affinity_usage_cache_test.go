...
func nextChannelAffinityUsageCacheTestPart(prefix string) string {
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := nextChannelAffinityUsageCacheTestPart("rule")
	usingGroup := "default"
	keyFP := nextChannelAffinityUsageCacheTestPart("fp")
