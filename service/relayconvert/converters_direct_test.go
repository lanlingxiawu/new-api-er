...
func TestStreamOrchestrationErrorAndEmptyPaths(t *testing.T) {
	...
	failState := &ResponseStreamState{
		...
		specs: []ResponseConverterSpec{{
			...
			ConvertStreamChunk: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any, _ any) ([]any, *dto.Usage, error) {
	...
	emptyState := &ResponseStreamState{
		From: types.RelayFormatOpenAI, To: fakeTo,
		specs: []ResponseConverterSpec{
			{ID: "empty", From: types.RelayFormatOpenAI, To: mid, ConvertStreamChunk: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any, _ any) ([]any, *dto.Usage, error) {
				return nil, nil, nil
			}},
			{ID: "never", From: mid, To: fakeTo, ConvertStreamChunk: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any, _ any) ([]any, *dto.Usage, error) {
	...
	finErrState := &ResponseStreamState{
		From: types.RelayFormatOpenAI, To: fakeTo,
		specs: []ResponseConverterSpec{{ID: "fin", From: types.RelayFormatOpenAI, To: fakeTo, FinalizeStream: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any) ([]any, *dto.Usage, error) {
			return nil, nil, sentinel
		}}},
		stepStates: []any{nil},
	}
	...
	finState := &ResponseStreamState{
		From: types.RelayFormatOpenAI, To: fakeTo,
		specs: []ResponseConverterSpec{{ID: "fin2", From: types.RelayFormatOpenAI, To: fakeTo, FinalizeStream: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any) ([]any, *dto.Usage, error) {
	...
	_, err = executeResponseSteps(nil, nil, types.RelayFormatOpenAI, fakeTo, &dto.OpenAITextResponse{}, "", ResponseConverterQualityFair,
		[]ResponseConverterSpec{{ID: "f", From: types.RelayFormatOpenAI, To: fakeTo, Convert: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any) (any, *dto.Usage, error) {
			return nil, nil, sentinel
		}}})
	require.ErrorIs(t, err, sentinel)

	// executeResponseStreamStep propagates a ConvertStream error (non-chunk path).
	_, _, err = executeResponseStreamStep(nil, nil, ResponseConverterSpec{ID: "s", ConvertStream: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any) (any, *dto.Usage, error) {
		return nil, nil, sentinel
	...
	finLaterErr := &ResponseStreamState{
		From: types.RelayFormatOpenAI, To: fakeTo,
		specs: []ResponseConverterSpec{
			{ID: "fin", From: types.RelayFormatOpenAI, To: mid, FinalizeStream: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any) ([]any, *dto.Usage, error) {
				return []any{"x"}, nil, nil
			}},
			{ID: "chunkfail", From: mid, To: fakeTo, ConvertStreamChunk: func(_ *gin.Context, _ *relaycommon.RelayInfo, _ any, _ any) ([]any, *dto.Usage, error) {
				return nil, nil, sentinel
			}},
		},
		stepStates: []any{nil, nil},
...
func TestRequestConverterFuncValueAndErrorBranches(t *testing.T) {
	...
	type reqFn func(*gin.Context, *relaycommon.RelayInfo, any) (any, error)
	cases := []struct {
		name   string
		fn     reqFn
...
func TestResponseConverterFuncErrorBranches(t *testing.T) {
	...
	type respFn func(*gin.Context, *relaycommon.RelayInfo, any) (any, *dto.Usage, error)
