...
func TestApplyReasoningModelSuffixBlacklistDoesNotTrim(t *testing.T) {
	...
	t.Cleanup(func() { model_setting.ReplaceGlobalSettings(original) })
	settings := original
	settings.ThinkingModelBlacklist = append(append([]string(nil), original.ThinkingModelBlacklist...), "claude-3-7-sonnet-thinking")
	model_setting.ReplaceGlobalSettings(settings)
...
func TestApplyReasoningModelSuffixGeminiNoThinkingWhenAdapterEnabled(t *testing.T) {
	...
	model_setting.ReplaceGeminiSettings(settings)
...
func TestApplyReasoningModelSuffixExactExemptionKeepsOpaqueName(t *testing.T) {
	...
	t.Cleanup(func() { model_setting.ReplaceGlobalSettings(original) })
	settings := original
	settings.ThinkingModelBlacklist = append(append([]string(nil), original.ThinkingModelBlacklist...), model)
	model_setting.ReplaceGlobalSettings(settings)
