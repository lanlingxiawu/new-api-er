...
本文档提供使用宝塔面板 Docker 功能部署 N123 Api 的图文教程。

> 📖 官方文档：[宝塔面板部署](https://docs.n123.ai/zh/docs/installation/deployment-methods/bt-docker-installation)
...
- [官方文档](https://docs.n123.ai/zh/docs/installation)
- [环境变量配置](https://docs.n123.ai/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://docs.n123.ai/zh/docs/support/faq)
