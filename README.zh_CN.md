...
📖 更多部署方式请参考 [部署指南](https://docs.n123.ai/zh/docs/installation)
...
### 📖 [官方文档](https://docs.n123.ai/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/new-api)
...
| 分类 | 链接 |
|------|------|
| 🚀 部署指南 | [安装文档](https://docs.n123.ai/zh/docs/installation) |
| ⚙️ 环境配置 | [环境变量](https://docs.n123.ai/zh/docs/installation/config-maintenance/environment-variables) |
| 📡 接口文档 | [API 文档](https://docs.n123.ai/zh/docs/api) |
| ❓ 常见问题 | [FAQ](https://docs.n123.ai/zh/docs/support/faq) |
| 💬 社区交流 | [交流渠道](https://docs.n123.ai/zh/docs/support/community-interaction) |

---

## ✨ 主要特性

> 详细特性请参考 [特性说明](https://docs.n123.ai/zh/docs/guide/wiki/basic-concepts/features-introduction)
...
> 详情请参考 [接口文档 - 网关接口](https://docs.n123.ai/zh/docs/api)

| 模型类型 | 说明 | 文档 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文档](https://docs.n123.ai/zh/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文档](https://docs.n123.ai/zh/docs/api/ai-model/chat/openai/createresponse) |
...
| 🔄 Rerank | Cohere、Jina | [文档](https://docs.n123.ai/zh/docs/api/ai-model/rerank/create-rerank) |
| 💬 Claude | Messages 格式 | [文档](https://docs.n123.ai/zh/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini 格式 | [文档](https://docs.n123.ai/zh/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow 模式 | - |
...
- [响应接口 (Responses)](https://docs.n123.ai/zh/docs/api/ai-model/chat/openai/createresponse)
- [图像接口 (Image)](https://docs.n123.ai/zh/docs/api/ai-model/images/openai/post-v1-images-generations)
- [音频接口 (Audio)](https://docs.n123.ai/zh/docs/api/ai-model/audio/openai/create-transcription)
- [视频接口 (Video)](https://docs.n123.ai/zh/docs/api/ai-model/audio/openai/createspeech)
...
- [实时对话 (Realtime)](https://docs.n123.ai/zh/docs/api/ai-model/realtime/createrealtimesession)
...
📖 **完整配置：** [环境变量文档](https://docs.n123.ai/zh/docs/installation/config-maintenance/environment-variables)
...
| [new-api-horizon](https://github.com/Calcium-Ion/new-api-horizon) | N123 Api 高性能优化版 |
...
| 📘 常见问题 | [FAQ](https://docs.n123.ai/zh/docs/support/faq) |
| 💬 社区交流 | [交流渠道](https://docs.n123.ai/zh/docs/support/community-interaction) |
| 🐛 反馈问题 | [问题反馈](https://docs.n123.ai/zh/docs/support/feedback-issues) |
| 📚 完整文档 | [官方文档](https://docs.n123.ai/zh/docs) |
...
**[官方文档](https://docs.n123.ai/zh/docs)** • **[问题反馈](https://github.com/Calcium-Ion/new-api/issues)** • **[最新发布](https://github.com/Calcium-Ion/new-api/releases)**
