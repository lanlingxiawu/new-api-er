...
func InitOptionMap() {
	...
	common.OptionMap["StripeUseRealtimeRate"] = strconv.FormatBool(setting.StripeUseRealtimeRate)
	...
	common.OptionMap["WechatMchPrivateKey"] = setting.WechatMchPrivateKey
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "StripeUseRealtimeRate":
		setting.StripeUseRealtimeRate = value == "true"
	case "StripeEnabled":
	...
	case "WechatMchPrivateKey":
		setting.WechatMchPrivateKey = value
	case "WechatMchCertSerialNo":
		setting.WechatMchCertSerialNo = value
	case "WechatMinTopUp":
...
func handleConfigUpdate(key, value string) bool {
	...
	} else if configName == "thirdpartysd2_pricing" {
